...
namespace _111111111111111
{
    ...
    public partial class Form1 : Form
    {
        ...
        public int TotalDegree(int attendance, int tasks, int midterm, int practice, int oral, int bonus, int final)
        {
            ...
            int total = addentence + midterm + practice + bonus + final + tasks + oral;
        ...
        private void label7_Click(object sender, EventArgs e)
        {
            ...
            int totalDegree = TotalDegree(addentence, tasks, midterm, oral, practice, bonus, final);
        ...
        private void lblshinfo_Click(object sender, EventArgs e)
        {
            ...
            FileStream fs = new FileStream("dataaaaaa.txt", FileMode.Append, FileAccess.Write);
            StreamWriter sw = new StreamWriter(fs);
            sw.WriteLine(txtname.Text + " " + txtid.Text + " " + txtsemester.Text);
        ...
        {
            int Total = TotalDegree(addentence, tasks, midterm, oral, practice, bonus, final);
            Form2 f2 = new Form2();
            f2.total = Total;
            f2.Show();
